...
import menu_oqtepa from "../../Items/restaraunts/MahallaMenu";
import BasketMenu from "../pages/BasketMenu";
import { Link, Outlet } from "react-router-dom";
import MainComponentMahalla from "../MainComponentMahalla";

const MahallaByGosht = () => {
  ...
  const handleClick = (e) => {
    if (e.target.outerText === "Fun-box") {
      ref.current?.scrollIntoView({ behavior: "smooth" });
    }
    if (e.target.outerText === "Закуски") {
    ...
    <div className="oqtepa-container">
      <div className="oqtepa-grid">
        ...
        <div className="menu-items border_radius">
          <div className="bg-theme-restaraunt bg-mahalla">
            <h1>Mahalla By Gosht</h1>
