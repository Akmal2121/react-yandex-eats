...
import menu_oqtepa from "../../Items/restaraunts/YaponaMamaMenu";
import BasketMenu from "../pages/BasketMenu";
import { Link, Outlet } from "react-router-dom";
import MainComponentFeedYapon from "../MainComponentFeedYapon";
...
const YaponaMama = () => {
  ...
  const handleClick = (e) => {
    if (e.target.outerText === "Сеты") {
      ref.current?.scrollIntoView({ behavior: "smooth" });
    }
    if (e.target.outerText === "Десерты") {
    ...
    <div className="oqtepa-container">
      <div className="oqtepa-grid">
        ...
        <div className="menu-items border_radius">
          <div className="bg-theme-restaraunt bg-yapon">
            <h1>Yapona Mama</h1>
