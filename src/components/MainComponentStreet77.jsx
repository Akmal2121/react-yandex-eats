...
import menu_oqtepa, { burger } from "../Items/restaraunts/Street77Menu";
import { lavash_oqtepa } from "../Items/restaraunts/Street77Menu";
import { useState } from "react";

const MainComponentStreet77 = React.forwardRef((props) => {
  ...
  return (
    <div className="main">
      {menu_oqtepa.map((item) => (
        <div key={item}>
          {item === "Пицца" ? <h1 ref={props.ref1}>{item}</h1> : null}
...
export default MainComponentStreet77;
